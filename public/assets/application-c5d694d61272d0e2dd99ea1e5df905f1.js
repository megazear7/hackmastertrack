...
(function() {
  $(function() {
    var count, show_fields;
    $(".character_select_for_item_purchase").change(function() {
      var action, char_id, form, id;
      id = $(this).attr("id");
    ...
    show_fields = function(elem) {
      ...
      if (item === "polearm") {
        ...
        $(".lodging-section").hide();
        $(".services-section").hide();
        return $(".transport-section").show();
      }
    };
    count = 0;
    $("#item_item_type").change(function() {
      return show_fields($(this));
    });
    return show_fields($("#item_item_type"));
  });

}).call(this);
(function() {
  this.updateSpecializations = function(characterId) {
    return $(".specializations").each(function(index, specialization) {
      var character_id, item_id, stat_name;
      ...
      if (character_id !== "" && stat_name !== "") {
        return $.getJSON("/specialization/retrieve" + ("?character_id=" + character_id) + ("&item_id=" + item_id) + ("&stat_name=" + stat_name), function(data) {
          ...
          for (_i = 0, _ref = data.value; 0 <= _ref ? _i < _ref : _i > _ref; 0 <= _ref ? _i++ : _i--) {
            $(specialization).find(".current-value").append("<span class='glyphicon glyphicon-stop'></span>");
          }
          _results = [];
          for (_j = _ref1 = data.value; _ref1 <= 5 ? _j < 5 : _j > 5; _ref1 <= 5 ? _j++ : _j--) {
            _results.push($(specialization).find(".current-value").append("<span class='glyphicon glyphicon-unchecked'></span>"));
          }
          return _results;
        });
      }
  ...
  $(function() {
    ...
    $(document).on('submit', 'form', function(e) {
      ...
      if (ability === "Strength") {
        ...
        return $(".charisma-section").remove();
        ...
        $(".wisdom-section").remove();
        $(".dexterity-section").remove();
        return $(".constitution-section").remove();
      }
    });
    show_fields = function(elem) {
      var ability, count;
      ...
      if (ability === "Strength") {
        ...
        $(".dexterity-section").hide();
        $(".constitution-section").hide();
        return $(".charisma-section").show();
      }
    };
    count = 0;
    $("#ability_score_ability").change(function() {
      return show_fields($(this));
    });
    return show_fields($("#ability_score_ability"));
  });
...
(function() {
  $(function() {
    var specsAccordion;
    $("#solr-full-search").submit(function(e) {
      var $results, phrase;
      e.preventDefault();
      phrase = $("#solr-search").val();
      $(".actual-search-result").slideUp({
        done: function() {
          return $(this).remove();
        }
      });
      if (phrase.trim() !== "") {
        ...
        return HackSolr.search(phrase, {
          ...
          return $.each(results, function() {
            ...
            result.slideDown();
            return $(".suggestions").slideUp();
          });
        });
      }
    });
    $("input#solr-search").on("input", function(e) {
      if ($(this).val().length > 3) {
        return HackSolr.suggest($(this).val(), function(suggestions) {
          var termsUsed;
          termsUsed = [];
    ...
    $(".suggestions div").click(function(e) {
    ...
    $("select.equip-item").each(function(index, select) {
    ...
    if ($(".class-option").length > 0) {
      $(".class-option").click(function(e) {
        ...
        return $("#race-name").text(selection.data('text'));
      });
    }
    if ($(".race-option").length > 0) {
      $(".race-option").click(function(e) {
        var selection;
        ...
        return $("#class-name").text(selection.data('text'));
      });
    }
    if ($(".alignment-option").length > 0) {
      $(".alignment-option").click(function(e) {
        var selection;
        ...
        return $("#alignment-name").text(selection.data('text'));
      });
    }
    if ($(".bp-option").length > 0) {
      return $(".bp-option").click(function(e) {
        var selection;
        selection = $(e.target).closest(".bp-option");
        if (selection.length === 0) {
          selection = $(e.target);
        }
        return $("#character_building_points").val(selection.data("value"));
      });
    }
  });
...
(function() {
  $(function() {
    ...
    if (itemGroupSelect.length > 0) {
      itemGroupSelect.change(function(e) {
        return itemGroupSelect.closest("form").submit();
      });
    }
    $(".character-select").change(function(e) {
      if ($(e.target).val()) {
        return updateSpecializations($(e.target).val());
      }
    });
    $("#solr-item-search").submit(function(e) {
      var phrase;
      e.preventDefault();
      phrase = $("#solr-search").val();
      if (phrase.trim() !== "") {
        return HackSolr.search(phrase, {
          ...
          $.each(results, function() {
            ...
            return $("tr.item_row_" + this.id).addClass("search-revealed");
          });
          return $(".item_group").each(function() {
        ...
        $(".item_group").show();
        $("tr.item_row").show();
        return $("tr.item_row").removeClass("search-revealed");
      }
    });
    return $("#solr-clear").click(function() {
      $(".item_group").show();
      $("tr.item_row").show();
      return $("tr.item_row").removeClass("search-revealed");
    });
